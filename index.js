...
const PASSWORD = 'Upwork123$';
const FILENAME = "upwork.txt";

// Proxy server details
// const PROXY_SERVER = 'http://5.154.253.150:8408';
...
const startScript = async () => {
  while (true) {
    ...
    try {
      ...
      const emailAddress = `${faker.person.firstName('male')}${faker.person.lastName()}${randomNumber()}@dealyaari.com`;
